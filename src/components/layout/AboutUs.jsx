    ...
    >
      ...
      <div>
        ...
        <div className="d-flex align-items-baseline">
          ...
          />
          <p>
            Мониторы для видеостен, интерактивное оборудование, мониторы для
            Digital Signage компании Vestel
          </p>
        </div>
        <div className="d-flex align-items-baseline">
          <img
          ...
          />
          <p>
            Решения для презентаций, отображения информации, видеостен,
            диспетчерских 24/7, учреждений образования и многое другое
          </p>
        </div>
        <div className="d-flex align-items-baseline">
          <img
      ...
      <div>
        <div className="d-flex align-items-baseline">
          ...
          />
          <p className="m">
            Проекционного оборудования и систем отображения информации
          </p>
        </div>
        <div className="d-flex align-items-baseline">
          <img
