  ...
  return (
    ...
    >
      ...
      <div className="d-flex align-items-baseline">
        <img src={"https://byprint.by/wp-content/uploads/2021/06/ff489f49.jpg"} alt="images" style={{width:"1rem"}}/>
        <p className="m">Проекционного оборудования компаний Optoma, InFocus</p>
      </div>
      <div className="d-flex align-items-baseline">
      <img src={"https://byprint.by/wp-content/uploads/2021/06/ff489f49.jpg"} alt="images" style={{width:"1rem"}}/>
        <p>Мониторы для видеостен, интерактивное оборудование, мониторы для Digital Signage компании Vestel</p>
      </div>
      <div className="d-flex align-items-baseline">
      <img src={"https://byprint.by/wp-content/uploads/2021/06/ff489f49.jpg"} alt="images" style={{width:"1rem"}}/>
        <p>Решения для презентаций, отображения информации, видеостен, диспетчерских 24/7, учреждений образования и многое другое</p>
      </div>
      <div className="d-flex align-items-baseline">
      <img src={"https://byprint.by/wp-content/uploads/2021/06/ff489f49.jpg"} alt="images" style={{width:"1rem"}}/>
        <p>Гарантийное и постгарантийное обслуживание поставленного оборудования </p>
      </div>
      </div>
      <p style={{ fontSize: "2rem", color: "#919191", fontWeight: "bold" }}>
        Дистрибуция
      ...
      <div className="d-flex align-items-baseline">
        <img src={"https://byprint.by/wp-content/uploads/2021/06/ff489f49.jpg"} alt="images" style={{width:"1rem"}}/>
        <p className="m">Проекционного оборудования и систем отображения информации</p>
      </div>
      <div className="d-flex align-items-baseline">
      <img src={"https://byprint.by/wp-content/uploads/2021/06/ff489f49.jpg"} alt="images" style={{width:"1rem"}}/>
      ...
      <div className="d-flex align-items-baseline">
      <img src={"https://byprint.by/wp-content/uploads/2021/06/ff489f49.jpg"} alt="images" style={{width:"1rem"}}/>
        <p>Официальный дистрибьютор (импртер) компании DIGIS, PROJECTA</p>
      </div>      
      </div>
